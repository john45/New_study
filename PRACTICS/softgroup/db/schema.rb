...
ActiveRecord::Schema.define(version: 20_170_329_194_116) do
  ...
  add_index 'images', %w(share_image_type share_image_id), name: 'index_images_on_share_image_type_and_share_image_id'
